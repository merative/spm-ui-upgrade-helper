...
2. Run the tool:
  ...
  Where:
    ...
    `INPUT_FOLDER` is the absolute path to the root of your 7.0.11.0 development environment.
    
    `OUTPUT_FOLDER` is the absolute path to your temporary output folder.
