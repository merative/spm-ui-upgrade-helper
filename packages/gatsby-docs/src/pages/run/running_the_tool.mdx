...
8. For more information about Window Size Tool changes, see [Reviewing Window Size Tool](https://github.com/IBM/spm-ui-upgrade-helper/blob/poraghal-docs-review-WST/packages/gatsby-docs/src/pages/setup/tools.mdx#reviewing-window-size-tool-changes).
