...
<InlineNotification>
   Note: The UI Upgrade helper is designed to upgrade from Social Program Management version 7 to version 8 only, and not to upgrade to a more recent version 7 release.
